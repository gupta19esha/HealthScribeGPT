...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchStarCount = async () => {
      try {
        const response = await fetch('https://api.github.com/repos/0xmetaschool/health-scribe-gpt');
        ...
        <div className="flex justify-between items-start">
          ...
          <div>
            ...
            <div className="text-black mb-4 text-2xl font-bold font-sans">
              Build your own Health Scribe GPT
            </div>
            <div className="flex items-center gap-4">
              <Link
                href="https://github.com/0xmetaschool/health-scribe-gpt/fork"
